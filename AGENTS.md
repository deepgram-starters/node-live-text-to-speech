...
Node.js demo app for Deepgram Live Text-to-Speech.
...
| `encoding` | `linear16` | `linear16` (8000/16000/24000/32000/44100/48000 Hz), `mulaw` (8000/16000 Hz), `alaw` (8000/16000 Hz) | Audio encoding |
...
```
feat(node-live-text-to-speech): add diarization support
fix(node-live-text-to-speech): resolve WebSocket close handling
refactor(node-live-text-to-speech): simplify session endpoint
